...
user: user
command: /sp.tasks
labels: [tasks, integration, frontend, backend, rag, docusaurus, fastapi]
links:
  ...
  data-model: specs/004-frontend-backend-intstruction/data-model.md
...
- Phase 3: User Story 1 - Chat UI Component (T011-T017)

        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/module-1/humanoid-urdf-modeling',
                component: ComponentCreator('/docs/module-1/humanoid-urdf-modeling', '006'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/module-1/intro-to-ros2',
                component: ComponentCreator('/docs/module-1/intro-to-ros2', '7d5'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/module-1/python-agents-ros2',
                component: ComponentCreator('/docs/module-1/python-agents-ros2', 'aeb'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
